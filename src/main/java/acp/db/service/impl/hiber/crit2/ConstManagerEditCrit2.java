...
public class ConstManagerEditCrit2 extends ManagerBaseHiber implements IConstManagerEdit {
  private static Logger logger = LoggerFactory.getLogger(ConstManagerEditCrit2.class);
