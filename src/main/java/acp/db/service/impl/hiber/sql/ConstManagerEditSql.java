...
public class ConstManagerEditSql extends ManagerBaseHiber implements IConstManagerEdit {
  private static Logger logger = LoggerFactory.getLogger(ConstManagerEditSql.class);
