...
public class FileLoadManagerEditCrit2 extends ManagerBaseHiber implements IFileLoadManagerEdit {
  private static Logger logger = LoggerFactory.getLogger(FileLoadManagerEditCrit2.class);
