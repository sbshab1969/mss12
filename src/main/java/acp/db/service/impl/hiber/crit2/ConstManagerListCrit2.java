...
public class ConstManagerListCrit2 extends ManagerListHiber<ConstDto> {
  private static Logger logger = LoggerFactory.getLogger(ConstManagerListCrit2.class);
...
//      crit.add(Property.forName("name").like(vName, MatchMode.START).ignoreCase());
    }
  }
