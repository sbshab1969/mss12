...
public class FileOtherManagerListCrit2 extends ManagerListHiber<FileOtherDto> {
  private static Logger logger = LoggerFactory.getLogger(FileOtherManagerListCrit2.class);
  ...
  public FileOtherManagerListCrit2(Long file_id) {
  ...
  private void addRestrictions(Criteria crit) {
    crit.add(Restrictions.eq("refId", fileId));
  }
